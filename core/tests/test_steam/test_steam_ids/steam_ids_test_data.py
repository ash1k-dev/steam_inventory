...
TEST_RESULT_STEAM_ID_CASE_1 = 76561198044176118

TEST_DATA_STEAM_ID_CASE_2 = {"response": {"steamid": "76561199004706307", "success": 1}}

TEST_RESULT_STEAM_ID_CASE_2 = 76561199004706307

LIST_STEAM_ID = [
    (
        TEST_DATA_STEAM_ID_CASE_1,
        TEST_RESULT_STEAM_ID_CASE_1,
    ),
    (
        TEST_DATA_STEAM_ID_CASE_2,
        TEST_RESULT_STEAM_ID_CASE_2,
    ),
]
...
TEST_RESULT_STEAM_NAME_CASE_1 = "ash"
...
TEST_RESULT_STEAM_NAME_CASE_2 = "Deny_X one"
...
TEST_RESULT_STEAM_NAME_CASE_3 = "LOLIBOOMKA"


LIST_STEAM_NAME = [
    (
        TEST_DATA_STEAM_NAME_CASE_1,
        TEST_RESULT_STEAM_NAME_CASE_1,
    ),
    (
        TEST_DATA_STEAM_NAME_CASE_2,
        TEST_RESULT_STEAM_NAME_CASE_2,
    ),
    (
        TEST_DATA_STEAM_NAME_CASE_3,
        TEST_RESULT_STEAM_NAME_CASE_3,
    ),
]
